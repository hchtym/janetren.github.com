...
/*==============================================================*/
CREATE OR REPLACE VIEW YKT_CUR.V_TIF_REPORT_OPER
...
from   (
      select a.serial_type,count(a.serial_type) trade_count,a.maindevice_id,
      a.device_id,OPER_CODE
      from (
       select a.serial_type,trade_count,a.maindevice_id,a.device_id,
      (CASE WHEN A.SERIAL_TYPE=847127 THEN A.RESERVE_1 ELSE a.oper_code END) OPER_CODE
