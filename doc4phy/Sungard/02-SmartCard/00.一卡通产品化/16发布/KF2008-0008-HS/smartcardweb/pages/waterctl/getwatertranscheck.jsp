...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function dowatertrans(){
			errmsg.innerHTML="请不要移走卡片，系统确认中，请稍后...";
		...
		<form action="/smartcardweb/watertrans.do" method="post"
			...
			<div id="middle">
				<div id="Layer1">
					...
					: String.valueOf(Double.parseDouble(request.getAttribute("cardBala")
							.toString()) / 100)%>
											元
										</td>
									</tr>
							...
							<div id="content_buttom">
								<table>
									<tr>
										<td align="center">
											<a onclick="javascript:dowatertrans();"
