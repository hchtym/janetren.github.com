...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body scroll="no" onload="javascript:setDate();">
		<form action="/smartcardweb/querytradeserial.do" method="post"
			...
			<div id="middle">
				<div id="Layer1">
					<div id="login">
						...
						<div id="login_middle">
							<div align="center">
								<img src="/smartcardweb/pages/images/input_date.gif" width="343"
									height="57" />
							</div>
							<div>
								<ul>
								...
								<table width="410" border="0" cellpadding="0"
									...
									<tr>
										<td width="206" align="right">
											<img src="/smartcardweb/pages/images/be_date.gif" width="114"
												height="24" />
									...
									<tr>
										<td align="right">
											<img src="/smartcardweb/pages/images/end_date.gif"
												width="114" height="23" />
										</td>
										<td>
