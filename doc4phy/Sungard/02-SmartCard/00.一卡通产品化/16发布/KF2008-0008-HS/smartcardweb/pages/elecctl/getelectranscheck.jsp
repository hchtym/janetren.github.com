...
<html>
	...
	<body scroll="no">
		<form action="/smartcardweb/electrans.do" method="post"
			name="writeCardForm">
			<div id="mid_top"></div>
			<div id="middle">
				<div id="Layer1">
					...
					: request.getAttribute("outCardAmount")%>" />
											<input type="hidden" name="room"
												value="<%=request.getAttribute("room") == null ? "" : request
					.getAttribute("room")%>" />
										</td>
										<td>
											<%=request.getAttribute("room") == null ? "" : request
					.getAttribute("room")%>
										</td>
									</tr>
									<tr>
										...
										<td>
											<%=request.getAttribute("sbankname") == null ? ""
					: request.getAttribute("sbankname")%>
										</td>
									</tr>
					...
					.getAttribute("money")%>
									...
									<tr>
										...
										<td>
											<%=request.getAttribute("ElecPrice") %>
											分
										</td>
									</tr>
									<tr>
