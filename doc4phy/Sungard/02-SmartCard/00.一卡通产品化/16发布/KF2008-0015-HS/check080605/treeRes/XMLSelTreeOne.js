	...
	if (m_oConfig.oCurrentNode != "moonpiazza")
	{
		...
		if ( !bIsAncestorNode )
		{
			...
			if ( !bIsOffspringNode )
			{
				...
				FoldAncestorNode(p_oSrcElement, m_oConfig.oCurrentNode);		// ????????????		
			}
		}
