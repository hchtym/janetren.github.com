...
function DoCheck1(ck,hid){
   ...
   if(ck.checked){
      ...
      eval("document.stucheckininfoForm.reason"+hid+"[3].checked=true;");
...
function DoSave(str){
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=update";
   document.stucheckininfoForm.submit();
}
...
function DoSaveAll(){
   ...
   document.stucheckininfoForm.action="checkinmanageAction.do?method=updateall";
   document.stucheckininfoForm.submit();
