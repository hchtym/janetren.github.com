...
<jodd:form bean="request">
       <%@ include file="/pages/common/messages.jsp" %>
        <table class="border" width=100% cellSpacing=0 cellPadding=2 align="center">
           <tr>
                <td class="left" width="20%">考勤班次:</td>
			...
			<tr>
                <td class="left" width="20%">是否上班:</td>
                <td class="right">
                   <c:out value="${ifWork}" />
                </td>
            </tr>
            <tr>
                <td colspan="2" class="bottom">
                    <input type="button" class="submitButton" name="submitButton" value="<c:out value='${btnInfo}' />"  style="margin-right:60px" onclick="<c:out value='${actionUrl}' />"/>
					 <input type="button" class="submitButton" name="submitButton" value=" 退 出 "  style="margin-right:60px" onclick="window.location.href='department.do?method=goDeptConf';"/>
