				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td height="40" align="left" valign="middle" class="tdborder02">
						    ...
						    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="createButton" type="button" class="submitButton" value="生成考勤数据" onclick="create.createButton.value='正在处理，请稍候...';create.createButton.disabled='true';create.submit();">
						</td>
					</tr>
				</table>
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td height="40" align="center" valign="middle" class="tdborder02">
							<input name="Submit" type="button" class="submitButton" value="启动自动生成数据功能" <c:out value='${openDisabled}' default="disabled"/> onclick="window.location.href='workInfo.do?method=openTread';">
							&nbsp;&nbsp;
							<input name="Submit" type="button" class="submitButton" value="关闭自动生成数据功能" <c:out value='${closeDisabled}' default="disabled"/> onclick="window.location.href='workInfo.do?method=closeTread';">
						</td>
					</tr>
				</table>
			</form>
