...
<center>
	...
	<gui:window title="<%=title%>" prototype="boWindow" color="100%">
		<gui:tabbedPanel prototype="boTabbedPanel" followUp="usermanag.jsp" color="#f0f0f0" selectedTab="tab1" width="78">
					...
					<table cellSpacing="0" cellPadding="0" width="100%" border="0">
						<tr>
							<td COLSPAN="2" ALIGN="RIGHT">
								<html:submit styleClass="button" onclick="chgAction(document.all.method,'loadAccount4Add');chgAction(document.all.opType,'add');"><bean:message key="button.add"/></html:submit>
								<html:submit styleClass="button" onclick="chgAction(document.all.method,'loadAccount4Edit');chgAction(document.all.opType,'edit');bCancel=true;return validSelectedIdForEdit();"><bean:message key="button.edit"/></html:submit>
								<html:submit styleClass="button" onclick="chgAction(document.all.method,'removeAccount');chgAction(document.all.opType,'delete');bCancel=true;return validSelectedIdForDelete();"><bean:message key="button.delete"/></html:submit>
							</td>
						</tr>
					</table>
