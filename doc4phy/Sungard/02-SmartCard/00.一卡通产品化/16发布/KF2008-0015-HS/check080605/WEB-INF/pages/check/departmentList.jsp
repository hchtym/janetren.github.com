...
var m_sXMLFile	= "getDepartmentXMLTree.do?method=getDepartmentXMLTree";
...
"<input id=ipt_Title type=hidden value=\"\">" + "" +

"部门名称:<input id=ipt_Caption type=textbox value=\"\">" + "<br>" +
...
{    
...

    {
        ...
        case "delete":
            ...
            if(confirm("注意！若是部门节点将删除此节点的所有部门。确认删除？"))

            {

                //DeleteNode(Select_Text,Select_Value);
                location.href='removeDepartment.do?method=remove&from=list&id='+Select_Value;
            }
...
/*       var rightedge= document.body.clientWidth-event.clientX;
       ...
       addormodify.style.left= document.body.scrollLeft+ event.clientX - addormodify.offsetWidth+100;

       else

       addormodify.style.left= document.body.scrollLeft+ event.clientX+100;

       if(bottomedge< addormodify.offsetHeight)

       addormodify.style.top= document.body.scrollTop+ event.clientY - addormodify.offsetHeight;
  ...
  */     
    ...
    {        
        ...
        location.href='departmentManager.do?method=load4edit&from=list&id='+Select_Value;
...

    {
        ...
        location.href='departmentManager.do?method=load4add&from=list&pid='+Select_Value;
    }    
