				...
				<table class="border" width=100% cellSpacing=0 cellPadding=2 align="center">
					<tr>
						...
						<td class="right" align="left">
							<select name="new_typeId" style="width:200">
					...
					<tr>
						...
						<td class="right">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="checkbox" value="1" name="new_sixWork">
							&nbsp;周六考勤
							&nbsp;
							<input type="checkbox" value="1" name="new_sevenWork">
							&nbsp;周日考勤
...
function onSubmit(){
	...
	if(clerkForm.new_typeId.value==""||clerkForm.new_typeId.value=="")
	{
		alert('请选择考勤部门');
	    return false;
	}
