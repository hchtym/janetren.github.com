...
<html>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		...
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 考勤补贴计算报表 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<jodd:form bean="request">
			    ...
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!-- <input name="createButton" type="button" class="submitButton" value="重新生成报表" onclick="javascript:makeReport('1')"/>
			  ...
			  <table width=85% border=1 cellpadding=1 cellspacing=0 bordercolor=#3462AD bordercolordark=#ffffff  id=submenu1>
		          <tbody>
		            <tr align="center" valign=center> 
		              ...
		              <td colspan=<c:out value="${dayNum}" /> valign="middle" ><strong><c:out value="${statDate}"/>月考勤补贴计算报表</strong></td>
		              <td rowspan="3" width="80" valign="middle" ><strong>总数</strong></td>
		              <td rowspan="3" width="100" valign="middle" ><strong>补贴(元)</strong></td>
		              <td></td>
		            </tr>
					...
					<%	}else{
						...
						while (checkIter.hasNext()){
							...
							totMoney = checkMap.get("totMoney").toString();
							%>
		            ...
		            <%}%>
		              ...
		              <td align="center" valign="middle" bgcolor="#FFFFFF" ><%=totMoney%></td>
		            </tr>
		            <%}}%>
...
function makeReport(makeSign)
{
    ...
    {
    	document.makeReportForm.action="checkStatic.do?method=getMakeCheckReport&makeSign="+makeSign;
