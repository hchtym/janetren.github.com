 ...
 if (!atleaseOneCheck())
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0">
		<div id="titleDiv" class="pageTitle">
			<strong> <font class="medium"> 取消申请查询 </font> </strong>
		</div>
		...
		<div id="filterDiv" style="text-align: left;">
			<form name="leaveRegister" action="leaveReportCheck.do?method=leaveReportCheckCancelQuery" method="post">
				<jodd:form bean="request">
						<input type=hidden name=query_ifcheck value='1'>
						申请日期(开始):
				...
				<ec:table items="leaveReportList" var="leave" rowsDisplayed="15" action="leaveReportCheck.do?method=leaveReportCheckQuery" form="leaveReport">
					...
					<ec:row>
						...
						<ec:column property="审批" 
							...
							sortable="false"
						>
							<a href="leaveReportCheck.do?method=leaveReportCheckCancel&leaveReportId=${leave.ID}">取消审批</a>
						</ec:column>
					</ec:row>
				</ec:table>
			</div>
