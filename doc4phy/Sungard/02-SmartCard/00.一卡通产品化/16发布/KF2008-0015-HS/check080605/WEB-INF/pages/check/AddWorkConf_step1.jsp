					...
					<tbody>
						<tr align="center" valign=center>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								<input name="add_confName" class="input_box" maxlength=30>
						...
						<tr>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								<input name="add_permitLateTime" class="input_box" maxlength=5 onblur="count(addConf.add_permitLateTime)">
						...
						<tr>
							...
							<td align="left" valign="middle" bgcolor="#E7F1F5">
								<input name="add_permitEarly" class="input_box" maxlength=5 onblur="count(addConf.add_permitEarly)">
								<font color=#ff0000>*</font>分钟
							</td>
						</tr>
						<tr>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								<input name="add_ondutyAdvancedTime" class="input_box" maxlength=5 onblur="count(addConf.add_ondutyAdvancedTime)">
								<font color=#ff0000>*</font>分钟
							</td>
						</tr>
						<tr>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								<input name="add_offDutyLastTime" class="input_box" maxlength=5 onblur="count(addConf.add_offDutyLastTime)">
								<font color=#ff0000>*</font>分钟
							</td>
						</tr>
						<tr>
							...
							<td width="78%" align="left" valign="middle" bgcolor="#E7F1F5">
								<input name="add_checkTime" class="input_box" maxlength=5 onblur="count(addConf.add_checkTime)">
								<font color=#ff0000>*</font>分钟
							</td>
						</tr>
						<tr>
