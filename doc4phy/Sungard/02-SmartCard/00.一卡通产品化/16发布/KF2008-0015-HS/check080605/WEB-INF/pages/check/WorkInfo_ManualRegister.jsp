		...
		<div id="filterDiv" style="text-align: left;">
			<form name="menualRegister" action="workInfo.do?method=searchClerk" method="post">
				<jodd:form bean="request">
					...
					-->
					<select name="register_clerkType" style="width: 150">
						<option value="">
							所有
						</option>
				...
				<ec:table items="clerkList" var="clerk" rowsDisplayed="5" action="workInfo.do?method=searchClerk" form="register">
					...
					<ec:row>
						...
						<ec:column property="学/工号" 
							...
							sortable="false"
						>
						<a href="clerkManager.do?method=queryClerkCheckDetail&custId=${clerk.CUT_ID}"><c:out value='${clerk.STUEMP_NO}'/></a>
