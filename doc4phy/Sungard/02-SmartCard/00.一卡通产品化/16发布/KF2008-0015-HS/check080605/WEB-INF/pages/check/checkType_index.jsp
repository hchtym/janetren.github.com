		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="40" align="left" valign="middle" class="tdborder02">
					...
					-->
					<input name="Submit" type="button" class="submitButton" value=" 删 除 " onclick="javascript:batch_del(document.forms.ec,'考勤制度','<c:url value="checkType.do?method=delete" />');">
				</td>
			</tr>
			<div id=lineDiv class="hrLine">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<div id="tableDiv"> <!-- style="display :<c:out value='${show}' default='none'/>"-->
				<ec:table items="checkTypeList" var="checkType" rowsDisplayed="12" action="workConf.do?method=search">
					...
					<ec:row>
						...
						<ec:column property="typeName" title="班次信息名称" width="85%" />
